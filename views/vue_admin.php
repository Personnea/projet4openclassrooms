...
class VueAdmin {
            ...
            <?php include('assets\includes\header.php'); ?>
                <div class="container">
                    ...
                    <div class="maincontent center premiere-section-admin">
                        ...
                        <button class="btn btn-success" onclick="location.href='index.php?module=admin&menu=ajouter'">Ajouter un article</button>
                        <hr>
                        ...
                        if(($nb_de_ligne = $req->rowCount()) > 0){
                            while($result = $req->fetch()){
                                ...
                                <div class="article-premiere-section">
                                    ...
                                    <hr>
                                    <a href="index.php?module=admin&menu=modifier&idarticle=<?php echo $result['id'];?>"><button class="btn btn-primary">Modifier cet article ?</button></a>
                                    <a href="index.php?module=admin&action=supprimer&idarticle=<?php echo $result['id'];?>"><button type="button" class="btn btn-danger">Supprimer cet article ?</button></a>                                  
                                    <hr>
                                </div>                               
        ...
        <html>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <form method="post" action="index.php?module=admin&action=ajouter">
    ...
    public function mod_article($req){
        ?>
        <!DOCTYPE html>
        <html>
            <head>
                    ...
                    <div class="row">
                        <?php
                         while($result = $req->fetch()){
                            ...
                            <form method="post" action="index.php?module=admin&action=modifier&idarticle=<?php echo $result['id'];?>">
